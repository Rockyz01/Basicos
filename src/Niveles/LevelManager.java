...
public class LevelManager {
    ...
    private void buildAllLevels() {
        ...
        // ── Configuración temática de enemigos por nivel ──────────────────
        // 9 enemigos (7 originales + 2 extra) + 1 jefe al final, alineados a
        // la temática del tileset:
        //   N1 bosque/jungla     → Toads, Slimes verdes, Goblins → TrolJefe
        ...
        Level.EnemyType[][] enemiesByLevel = {
            ...
            // N2 — bosque otoñal: hombres-ciervo y goblins arqueros (9 enemigos)
            { Level.EnemyType.ENEMIGO1, Level.EnemyType.ENEMIGO15, Level.EnemyType.ENEMIGO12,
              Level.EnemyType.ENEMIGO1, Level.EnemyType.ENEMIGO15, Level.EnemyType.ENEMIGO12,
              Level.EnemyType.ENEMIGO1, Level.EnemyType.ENEMIGO15, Level.EnemyType.ENEMIGO12 },

            // N3 — nieve: golems de hielo, yetis y vikingos (9 enemigos)
            { Level.EnemyType.ENEMIGO2, Level.EnemyType.ENEMIGO5, Level.EnemyType.ENEMIGO4,
              Level.EnemyType.ENEMIGO5, Level.EnemyType.ENEMIGO2, Level.EnemyType.ENEMIGO4,
              Level.EnemyType.ENEMIGO5, Level.EnemyType.ENEMIGO2, Level.EnemyType.ENEMIGO4 },

            // N4 — lava/desierto: escorpiones, buitres, bichos (9 enemigos)
            { Level.EnemyType.ENEMIGO10, Level.EnemyType.ENEMIGO11, Level.EnemyType.ENEMIGO13,
              Level.EnemyType.ENEMIGO10, Level.EnemyType.ENEMIGO13, Level.EnemyType.ENEMIGO11,
              Level.EnemyType.ENEMIGO10, Level.EnemyType.ENEMIGO11, Level.EnemyType.ENEMIGO13 },

            // N5 — ciudad/castillo: pseudo-aleatorio (esqueletos + varios) (9 enemigos)
            { Level.EnemyType.GOLEM,     Level.EnemyType.ENEMIGO14, Level.EnemyType.ENEMIGO3,
              Level.EnemyType.GOLEM,     Level.EnemyType.ENEMIGO3,  Level.EnemyType.ENEMIGO14,
              Level.EnemyType.GOLEM,     Level.EnemyType.ENEMIGO3,  Level.EnemyType.ENEMIGO14 },
        };

        Level.EnemyType[] bossByLevel = {
            Level.EnemyType.BOSS_TROL,
        ...
        for (int i = 0; i < allLevels.length; i++) {
            ...
            if (i < enemiesByLevel.length) {
                lvl.populateLevelEnemies(enemiesByLevel[i], bossByLevel[i]);
            } else {
