package Elementos;
// Elkman — cuerpo a cuerpo, velocidad media
// Sprite: 6cols x 5rows @ 48px
// Fila 0=IDLE(6), 1=CAMINAR(5), 2=MUERTO(2), 3=ATACAR(4), 4=GOLPE(4)
import Juegos.Juego;
...
public class enemigo1 extends Enemy {
    ...
    public enemigo1(float x, float y) {
        super(x, y, ENEMIGO1_WIDTH, ENEMIGO1_HEIGHT, ENEMIGO1);
        initHitBox(20, 26);
        initAttackBox();
