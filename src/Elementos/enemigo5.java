package Elementos;
// Snowy — ágil, corre y ataca
// Sprite: 6cols x 5rows @ 48px
// Fila 0=IDLE(4), 1=CAMINAR(6), 2=MUERTO(2), 3=ATACAR(4), 4=CORRER(6)
import Juegos.Juego;
import static Utilz.Constantes.Direccion.*;
import static Utilz.Constantes.EnemyConstants.*;
import java.awt.geom.Rectangle2D;

public class enemigo5 extends Enemy {
    private int attackBoxOffsetX;

    public enemigo5(float x, float y) {
        super(x, y, ENEMIGO5_WIDTH, ENEMIGO5_HEIGHT, ENEMIGO5);
        initHitBox(18, 24);
        initAttackBox();
        walkSpeed = Juego.SCALE * 0.65f;
    }
