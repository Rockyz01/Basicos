...
/**
 * Enemigo 13 - Bug (Escarabajo)
 * Sprite: Bug.png  |  4 cols x 5 rows  |  frame 48x48
 * Fila 0=INACTIVO  1=CORRER  2=ATACAR1  3=GOLPE  4=MUERTO
 */
public class enemigo13 extends Enemy {

    private int attackBoxOffsetX;

    public enemigo13(float x, float y) {
        super(x, y, ENEMIGO13_WIDTH, ENEMIGO13_HEIGHT, ENEMIGO13);
    ...
    private void initAttackBox() {
        attackBox = new Rectangle2D.Float(x, y,
                (int) (20 * Juego.SCALE), (int) (18 * Juego.SCALE));
        attackBoxOffsetX = (int) (Juego.SCALE * 22);
    }
