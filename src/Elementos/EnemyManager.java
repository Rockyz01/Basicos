...
public class EnemyManager {
	...
	public void update(int[][] lvlData, Jugador jugador) {
		...
		for (TrolJefe  s : trolJefes)  if (s.isActive()) { s.update(lvlData, jugador); isAnyActive = true; isAnyBossActive = true; }
		...
		// enemigos comunes pueden seguir vivos y el nivel termina igual al
	...
	public void checkFlechasHit(Jugador jugador) {
		...
		for (skeletonW e : Skeletonw)  tryArrowHit(e, jugador, 100);
		for (skeletonY e : skeletony)  tryArrowHit(e, jugador, 100);
		for (enemigo1  e : enemigos1)  tryArrowHit(e, jugador, 100);
		for (enemigo2  e : enemigos2)  tryArrowHit(e, jugador, 100);
		for (enemigo3  e : enemigos3)  tryArrowHit(e, jugador, 100);
		for (enemigo4  e : enemigos4)  tryArrowHit(e, jugador, 100);
		for (enemigo5  e : enemigos5)  tryArrowHit(e, jugador, 100);
		for (enemigo6  e : enemigos6)  tryArrowHit(e, jugador, 100);
		for (enemigo7  e : enemigos7)  tryArrowHit(e, jugador, 100);
		for (enemigo8  e : enemigos8)  tryArrowHit(e, jugador, 100);
		for (enemigo9  e : enemigos9)  tryArrowHit(e, jugador, 100);
		for (enemigo10 e : enemigos10) tryArrowHit(e, jugador, 100);
		for (enemigo11 e : enemigos11) tryArrowHit(e, jugador, 100);
		for (enemigo12 e : enemigos12) tryArrowHit(e, jugador, 100);
		for (enemigo13 e : enemigos13) tryArrowHit(e, jugador, 100);
		for (enemigo14 e : enemigos14) tryArrowHit(e, jugador, 100);
		for (enemigo15 e : enemigos15) tryArrowHit(e, jugador, 100);
		for (TrolJefe  e : trolJefes)  tryArrowHit(e, jugador, 500);
	...
	private void tryArrowHit(Enemy e, Jugador jugador, int scoreValue) {
		if (!e.isActive() || e.getEnemyState() == MUERTO || e.getEnemyState() == GOLPE) return;
		int dmg = jugador.checkFlechaHit(e.getHitbox());
		if (dmg > 0) {
			e.hurt(dmg);
			if (e.getEnemyState() == MUERTO) playing.increaseScore(scoreValue);
		}
	}

	public void checkBolasHit(Jugador jugador) {
		for (Golem e : golems)         tryFireballHit(e, jugador, 100);
		for (skeletonW e : Skeletonw)  tryFireballHit(e, jugador, 100);
		for (skeletonY e : skeletony)  tryFireballHit(e, jugador, 100);
		for (enemigo1  e : enemigos1)  tryFireballHit(e, jugador, 100);
		for (enemigo2  e : enemigos2)  tryFireballHit(e, jugador, 100);
		for (enemigo3  e : enemigos3)  tryFireballHit(e, jugador, 100);
		for (enemigo4  e : enemigos4)  tryFireballHit(e, jugador, 100);
		for (enemigo5  e : enemigos5)  tryFireballHit(e, jugador, 100);
		for (enemigo6  e : enemigos6)  tryFireballHit(e, jugador, 100);
		for (enemigo7  e : enemigos7)  tryFireballHit(e, jugador, 100);
		for (enemigo8  e : enemigos8)  tryFireballHit(e, jugador, 100);
		for (enemigo9  e : enemigos9)  tryFireballHit(e, jugador, 100);
		for (enemigo10 e : enemigos10) tryFireballHit(e, jugador, 100);
		for (enemigo11 e : enemigos11) tryFireballHit(e, jugador, 100);
		for (enemigo12 e : enemigos12) tryFireballHit(e, jugador, 100);
		for (enemigo13 e : enemigos13) tryFireballHit(e, jugador, 100);
		for (enemigo14 e : enemigos14) tryFireballHit(e, jugador, 100);
		for (enemigo15 e : enemigos15) tryFireballHit(e, jugador, 100);
		for (TrolJefe  e : trolJefes)  tryFireballHit(e, jugador, 500);
	...
	private void tryFireballHit(Enemy e, Jugador jugador, int scoreValue) {
		if (!e.isActive() || e.getEnemyState() == MUERTO || e.getEnemyState() == GOLPE) return;
		int dmg = jugador.checkBolaDeFuegoHit(e.getHitbox());
		if (dmg > 0) {
			e.hurt(dmg);
			if (e.getEnemyState() == MUERTO) playing.increaseScore(scoreValue);
		}
