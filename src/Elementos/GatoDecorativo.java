 ...
 * No camina, no colisiona, no interactúa. Solo cicla muy lentamente
 * los frames del idle (cabeza moviéndose, parpadeando, etc.).
 *
...
public class GatoDecorativo {
    ...
    /** Duración de cada frame en ticks. Todos iguales para que cicle la fila completa. */
    private static final int[] FRAME_DURATION = { 20, 20, 20, 20, 20, 20 };
