...
public class LevelManager {
    ...
    private Juego game;
    private BufferedImage[][] levelSprites;  // un array de tiles por cada atlas
...
private void importOutsideSprites() {
    BufferedImage img1 = LoadSave.GetSpriteAtlas(LoadSave.LEVEL_ATLAS);
    ...
    BufferedImage img4 = LoadSave.GetSpriteAtlas(LoadSave.LEVEL_ATLAS4);
    BufferedImage img5 = LoadSave.GetSpriteAtlas(LoadSave.LEVEL_ATLAS5);
    ...
    public void loadNextLevel(int indexOverride) {
        if (!(indexOverride >= 0 && indexOverride < levels.size())) {
            ...
            if (lvlIndex >= levels.size()) {
                if (completedLevels.containsAll(Set.of(0, 1, 2))) {
                    lvlIndex = 0;
    ...
    public void draw(Graphics g, int lvlOffset) {
        ...
        // Usar el atlas correspondiente al nivel actual
