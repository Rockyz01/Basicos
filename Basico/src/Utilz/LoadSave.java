...
public class LoadSave {
    ...
    public static final String LEVEL_ATLAS =  "outside_sprites2.png";
    public static final String LEVEL_ATLAS2 = "outside3_sprites.png";
    public static final String LEVEL_ATLAS3 = "outside4_sprites.png";
    public static final String LEVEL_ATLAS4 = "outside5_cyberpunk.png";
    public static final String LEVEL_ATLAS5 = "outside7_sprites.png";
    ...
    public static final String PLAYING_BG_IMG = "playing_bg_img3.png";
    public static final String PLAYING_BG_IMG2 = "playing_bg_img4.png";  
    public static final String PLAYING_BG_IMG3 = "background_layer_1.png";
    public static final String PLAYING_BG_IMG4 = "playing_bg_city.png";
    public static final String PLAYING_BG_IMG5 = "playing_bg_snow.png"; 
...
public static class WeaponConstants {
    ...
    // Identificadores para detectarlos en el PNG del nivel (canal AZUL)
    // Pociones ya usan blue 0 y 1, contenedores 2 y 3, spike 4, cannons 5 y 6
    // Así que las armas empiezan en 10 y armaduras en 20
