...
//    private int maxTilesOffset=lvlTilesWide-Juego.TILES_WIDTH;
  private int maxLvlOffsetX;
    ...
    public Playing(Juego juego) {
        super(juego);
        inicializar();backgroundImgs = new BufferedImage[5];
backgroundImgs[0] = LoadSave.GetSpriteAtlas(LoadSave.PLAYING_BG_IMG);
backgroundImgs[1] = LoadSave.GetSpriteAtlas(LoadSave.PLAYING_BG_IMG2);
backgroundImgs[2] = LoadSave.GetSpriteAtlas(LoadSave.PLAYING_BG_IMG3);
backgroundImgs[3] = LoadSave.GetSpriteAtlas(LoadSave.PLAYING_BG_IMG4);
backgroundImgs[4] = LoadSave.GetSpriteAtlas(LoadSave.PLAYING_BG_IMG5);
	...
	public void update() {
        if(paused){
            ...
            switch(Lvl){
                case 0: getJuego().setLEVEL1(true);
                break;
                case 1: getJuego().setLEVEL2(true);
                break;
                case 2: getJuego().setLEVEL3(true);
                break;
                default:
                    break;
        }
    ...
    g.setFont(g.getFont().deriveFont(30f)); // Fuente tamaño 30
